package com.mo.lib.utils.systemUtils;
...
public class ServiceUtil {
    ...
    public static boolean isRuning(Class<? extends Service> service) {
        // 获取运行中服务
        List<ActivityManager.RunningServiceInfo> services = ((ActivityManager) k.app().getSystemService(Context.ACTIVITY_SERVICE)).getRunningServices(1000);
