package com.mo.lib.utils.app_utils;
...
import com.mo.lib.k;
import com.mo.lib.utils.activity_utils.ActivitysUtil;
import com.mo.lib.utils.beng_utils.IntentUtil;
import com.mo.lib.utils.dataUtil.stringUtils.StringUtil;
import com.mo.lib.utils.file_utils.FileUtil;
import com.mo.lib.utils.systemUtils.CleanUtils;
import com.mo.lib.utils.systemUtils.ProcessUtil;
import com.mo.lib.utils.systemUtils.ShellUtil;
...
import static com.mo.lib.BuildConfig.DEBUG;
...
//            }
    ...
    public static boolean isAppForeground(final String packageName) {
        return !StringUtil.isSpace(packageName) && packageName.equals(ProcessUtil.getForegroundProcessName());
    }
