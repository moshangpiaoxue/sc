package com.mo.lib.utils.dataUtil.date;



import com.mo.lib.modle.unit.TimeUnit;
import com.mo.lib.utils.dataUtil.LongUtil;
...
import static com.mo.lib.modle.unit.TimeUnit.DAY;
import static com.mo.lib.modle.unit.TimeUnit.HOUR;
import static com.mo.lib.modle.unit.TimeUnit.MIN;
import static com.mo.lib.modle.unit.TimeUnit.MSEC;
import static com.mo.lib.modle.unit.TimeUnit.SEC;
import static com.mo.lib.utils.dataUtil.date.CalendarUtil.getCalendar;
import static com.mo.lib.utils.dataUtil.date.DateFormatUtil.getSDF;
...
public class DateUtil {
    ...
    public static long getMS(long time) {
        ...
        if (size == 10||LongUtil.getLongSize(Math.abs(time))==10) {
            return time * 1000;
        } else if (size == 13) {
            return time;
        } else {
