...
import com.mo.lib.action.ActivityAction;
import com.mo.lib.action.BundleAction;
import com.mo.lib.action.ClickAction;
...
public abstract class BaseActivity extends FragmentActivity implements
    ...
    protected void initActivity() {
        initLayout();
        initView();
        //性能优化，使用IdleHandler回调让耗时操作在activity调用merger加载完view之后再加载数据
