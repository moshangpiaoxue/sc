...
public class DragViewHelper implements View.OnTouchListener {
    ...
    private void initDragView() {
        ...
        LogUtil.i("mScreenWidth==" + mScreenWidth + "\t" + "getDragView().getWidth()==" + getDragView().getMeasuredWidth());
//        FrameLayout.LayoutParams layoutParams = createLayoutParams((int) (mScreenWidth * 0.8), mStatusBarHeight + mBuilder.defaultTop, 0, 0);
    ...
    private static DragViewHelper createDragView(Builder builder) {
        if (null == builder) {
        ...
        DragViewHelper dragViewHelper = new DragViewHelper(builder);
        return dragViewHelper;
    }
    ...
    public static class Builder {
        ...
        public Builder setView(View view, View.OnClickListener listener) {
