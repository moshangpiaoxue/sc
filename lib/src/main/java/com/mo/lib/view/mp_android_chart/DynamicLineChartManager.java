package com.mo.lib.view.mp_android_chart;
...
public class DynamicLineChartManager {
    ...
    //一条曲线
    public DynamicLineChartManager(Context context, LineChart mLineChart, String name, int color) {
        this.lineChart = mLineChart;
        this.context = context;
        leftAxis = lineChart.getAxisLeft();
        leftAxis.setTextColor(Color.rgb(63,91,107));
        leftAxis.setGridColor(Color.rgb(63,91,107));
        leftAxis.setAxisLineColor(Color.rgb(63,91,107));
        rightAxis = lineChart.getAxisRight();
        rightAxis.setEnabled(false);

        xAxis = lineChart.getXAxis();
        xAxis.setAxisLineColor(Color.rgb(245,133,179));
        initLineChart();
...
//        xAxis.setAxisLineColor(Color.rgb(245,133,179));
    ...
    private void initLineChart() {
        ...
        lineChart.setTouchEnabled(false);//禁止触摸事件
...
//        });
    ...
    private void initLineDataSet(String name, int color) {
        ...
        lineDataSet.setDrawCircles(false);  //设置有圆点
        ...
        lineDataSet.setFillColor(Color.rgb(245,133,179));
//        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.fade_pink);
...
//        timeList.add(" ");
    ...
    public void addEntry(List<Integer> numbers) {
        ...
        for (int i = 0; i < numbers.size(); i++) {
            ...
            lineData.notifyDataChanged();
            lineChart.notifyDataSetChanged();
            lineChart.setVisibleXRangeMaximum(12000);
            lineChart.moveViewToX(lineData.getEntryCount() - 5);
        }
    }
