...
import com.mo.lib.utils.viewUtil.BackgroundUtil;
...
public class BadgeViewPro extends AppCompatTextView {
    ...
    private void setTextBgShape() {
        switch (shape_type) {
            case SHAPE_CIRCLE:
                BackgroundUtil.setCircleBg(this, bgColor);
                break;
            case SHAPE_OVAL:
                BackgroundUtil.setOvalBg(this, bgColor);
                break;
            case SHAPE_RECTANGLE:
                BackgroundUtil.setRectBg(this, bgColor);
                break;
            case SHAPE_ROUND_RECTANGLE:
                BackgroundUtil.setRoundRectBg(mContext, this, 9, bgColor);
                break;
            default:
                break;
        }
