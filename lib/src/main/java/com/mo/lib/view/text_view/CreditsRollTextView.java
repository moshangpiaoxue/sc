...
package com.mo.lib.view.text_view;
...
/**
 * @ author：mo
 * @ data：2020/7/16:11:30
 * @ 功能：星球大战样式的滚动TextView
 */
public class CreditsRollTextView extends AppCompatTextView {
    ...
    public CreditsRollTextView(Context context) {
        super(context);
        init(null, 0, context);
    }

    public CreditsRollTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CreditsRollTextView(Context context, AttributeSet attrs, int defStyle) {
